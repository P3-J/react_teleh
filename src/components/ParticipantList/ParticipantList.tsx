...
export default function ParticipantList() {
  ...
  if (speakerViewParticipants.length === 0 && !isLocalParticipantScreenSharing) return null;
  // Don't render this component if there are no remote participants and local participant is not sharing the screen.
  return (
    <aside
